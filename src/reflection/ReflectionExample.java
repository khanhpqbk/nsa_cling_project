...
//				Field field = rental.getField(oneField.getName());
				...
				Object value = oneField.get(rent);
			...
			Field[] dclField = rental.getDeclaredFields();

			Class name = privateField.getType();
			System.out.println("One private Fieldname is: " + name.toString());
